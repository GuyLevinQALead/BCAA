...
public class PageManager extends Base {
    ...
    public static void InitiatePages(){
        ...
        casePage = PageFactory.initElements(driver, Pages.CasePage.class);
        fieldServiceSettingsPage = PageFactory.initElements(driver, Pages.FieldServiceSettingsPage.class);
